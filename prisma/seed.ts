...
const sectionsData = [
  {
    ...
    tags: ['free', 'hero', 'banner', 'image', 'cta', 'full-width', 'overlay'],
    previewImage: null,
    baseTemplate: `{% comment %}
  Hero Banner Section
...
{% endschema %}`
  },
  {
    ...
    tags: ['premium', 'products', 'grid', 'collection', 'shop', 'responsive'],
    previewImage: null,
    baseTemplate: `{% comment %}
...
{% endschema %}`
  },
  {
    ...
    tags: ['free', 'image', 'text', 'two-column', 'content', 'layout'],
    previewImage: null,
    baseTemplate: `{% comment %}
...
{% endschema %}`
  },
  {
    ...
    tags: ['premium', 'testimonials', 'slider', 'reviews', 'carousel', 'social-proof'],
    previewImage: null,
    baseTemplate: `{% comment %}
...
{% endschema %}`
  },
  {
    ...
    tags: ['free', 'features', 'columns', 'icons', 'benefits', 'three-column'],
    previewImage: null,
    baseTemplate: `{% comment %}
